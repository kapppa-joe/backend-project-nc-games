module.exports = [
  {
    ...
    category: "strategy",
    created_at: new Date(1612764020514),
    votes: 1,
  },
  {
    title: "JengARRGGGH!",
    ...
    category: "dexterity",
    created_at: new Date(1621764101251),
    votes: 5,
  },
  {
    ...
    created_at: new Date(1616764102151),
    votes: 5,
  },
  {
    ...
    category: "hidden-roles",
    created_at: new Date(1629764101251),
    votes: 5,
  },
  {
  ...
  },
  {
    ...
    created_at: new Date(1626764101251),
    votes: 10,
  },
  {
  ...
  },
  {
    ...
    created_at: new Date(1623761824839),
    votes: 100,
  },
  {
    ...
    category: "strategy",
    created_at: new Date(1613761824400),
    votes: 16,
  },
  {
    ...
    category: "dexterity",
    created_at: new Date(1622222350936),
    votes: 7,
  },
  {
    ...
    category: "engine-building",
    created_at: new Date(1607760368077),
    votes: 5,
  },
  {
  ...
  },
  {
    ...
    category: "dexterity",
    created_at: new Date(1626763414963),
    votes: 9,
  },
  {
    ...
    category: "hidden-roles",
    created_at: new Date(1633764446563),
    votes: 3,
  },
  {
    ...
    category: "strategy",
    created_at: new Date(1619765305936),
    votes: 1,
  },
  {
    ...
    category: "deck-building",
    created_at: new Date(1618763505936),
    votes: 1,
  },
  {
    ...
    category: "strategy",
    created_at: new Date(1625764002791),
    votes: 6,
  },
  {
    title: "Reef",
    ...
    category: "strategy",
    created_at: new Date(1628764002791),
    votes: 6,
  },
  {
    title: "Twister",
    ...
    review_body:
      "Fugiat fugiat enim officia laborum quis. Aliquip laboris non nulla nostrud magna exercitation in ullamco aute laborum cillum nisi sint. Culpa excepteur aute cillum minim magna fugiat culpa adipisicing eiusmod laborum ipsum fugiat quis. Mollit consectetur amet sunt ex amet tempor magna consequat dolore cillum adipisicing. Proident est sunt amet ipsum magna proident fugiat deserunt mollit officia magna ea pariatur. Ullamco proident in nostrud pariatur. Minim consequat pariatur id pariatur adipisicing.",
    category: "roll-and-write",
    created_at: new Date(1617760368077),
    votes: 8,
  },
  {
    title: "Monopoly",
    ...
    category: "strategy",
    created_at: new Date(1616760060877),
    votes: 3,
  },
  {
    ...
    category: "roll-and-write",
    created_at: new Date(1613760368077),
    votes: 8,
  },
  {
    title: "Yahtzee",
    ...
    category: "roll-and-write",
    created_at: new Date(1611160360077),
    votes: 18,
  },
  {
    ...
    category: "push-your-luck",
    created_at: new Date(1631764545410),
    votes: 18,
  },
  {
    ...
    category: "push-your-luck",
    created_at: new Date(1630764545610),
    votes: 11,
  },
];
